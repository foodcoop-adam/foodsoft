...
ActiveRecord::Schema.define(:version => 20140102170431) do
  ...
  create_table "group_order_article_quantities", :force => true do |t|
    ...
    t.decimal  "quantity",               :precision => 8, :scale => 3, :default => 0
    t.decimal  "tolerance",              :precision => 8, :scale => 3, :default => 0
    t.datetime "created_on",                                                          :null => false
  end
  ...
  create_table "group_order_articles", :force => true do |t|
    ...
    t.decimal  "quantity",         :precision => 8, :scale => 3, :default => 0, :null => false
    t.decimal  "tolerance",        :precision => 8, :scale => 3, :default => 0, :null => false
